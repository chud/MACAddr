  ...
  def initialize(mac_addr, format='colon_hex')
    ...
    if @words = re_parse.match(mac_addr)
  	...
  	@oui_list = {
		...
		'0x4C3089' => 'Thales Rail Signalling Solutions GmbH',
		...
		'0x000E89' => 'CLEMATIC',
		'0x001BA0' => 'Awox',
		'0x0040CC' => 'SILCOM MANUFG TECHNOLOGY INC.',
		...
		'0xF87B7A' => 'Motorola Mobile Devices',
		...
		'0x0014AD' => 'Gassner Wiege- u. MeÃtechnik GmbH',
		...
		'0x6487D7' => 'PIRELLI BROADBAND SOLUTIONS ',
		...
		'0x74B9EB' => 'Fujian Goldcat Electronic Technology Co.,Ltd.',
